...
namespace TheLongDarkBuckupTools.MoreData
{
    ...
    public class AfflictionsContainer
    {
        ...
        /// <summary>
        /// 构造函数，初始化疾病容器并加载全局游戏数据中的疾病状态
        /// </summary>
        /// <param name="global">全局游戏数据对象</param>
        public AfflictionsContainer(GlobalSaveGameFormat global)
        {
            // 为负面和正面疾病状态集合添加变更事件处理
        ...
        /// 将低温症数据从代理对象转换为疾病对象
        /// </summary>
        /// <param name="proxy">低温症数据代理对象</param>
        ...
        /// 将冻伤数据从代理对象转换为疾病对象
        /// </summary>
        /// <param name="proxy">冻伤数据代理对象</param>
        ...
        /// 将食物中毒数据从代理对象转换为疾病对象
        /// </summary>
        /// <param name="proxy">食物中毒数据代理对象</param>
        ...
        /// 将痢疾数据从代理对象转换为疾病对象
        /// </summary>
        /// <param name="proxy">痢疾数据代理对象</param>
        ...
        /// 将脚踝扭伤数据从代理对象转换为疾病对象
        /// </summary>
        /// <param name="proxy">脚踝扭伤数据代理对象</param>
        ...
        /// 将手腕扭伤数据从代理对象转换为疾病对象
        /// </summary>
        /// <param name="proxy">手腕扭伤数据代理对象</param>
        ...
        /// 将烧伤数据从代理对象转换为疾病对象
        /// </summary>
        /// <param name="proxy">烧伤数据代理对象</param>
        ...
        /// 将电击烧伤数据从代理对象转换为疾病对象
        /// </summary>
        /// <param name="proxy">电击烧伤数据代理对象</param>
        ...
        /// 将失血数据从代理对象转换为疾病对象
        /// </summary>
        /// <param name="proxy">失血数据代理对象</param>
        ...
        /// 将感染数据从代理对象转换为疾病对象
        /// </summary>
        /// <param name="proxy">感染数据代理对象</param>
        ...
        /// 将感染风险数据从代理对象转换为疾病对象
        /// </summary>
        /// <param name="proxy">感染风险数据代理对象</param>
        ...
        /// <summary>
        /// 将幽闭恐惧症数据从代理对象转换为疾病对象
        /// </summary>
        /// <param name="proxy">幽闭恐惧症数据代理对象</param>
        ...
        /// <summary>
        /// 将肠道寄生虫数据从代理对象转换为疾病对象
        /// </summary>
        /// <param name="proxy">肠道寄生虫数据代理对象</param>
        ...
        /// 将肋骨骨折数据从代理对象转换为疾病对象
        /// </summary>
        /// <param name="proxy">肋骨骨折数据代理对象</param>
        ...
        /// 将饱食状态数据从代理对象转换为疾病对象
        /// </summary>
        /// <param name="proxy">饱食状态数据代理对象</param>
        ...
        /// <summary>
        /// 将编辑器中的低体温症（Hypothermia）相关状态转换回存档代理对象。
        /// </summary>
        /// <param name="proxy">原始的存档代理对象，如果为 null 则创建新实例。</param>
        /// <param name="afflictionDict">包含当前所有疾病状态的字典，键为疾病类型，值为疾病列表。</param>
        /// <returns>
        /// 更新后的 HypothermiaSaveDataProxy 对象。
        /// 如果字典中不存在低体温症或其风险状态，且原代理对象有持续时间记录，则返回重置后的新对象。
        /// </returns>
        ...
        /// <summary>
        /// 将编辑器中的冻伤（Frostbite）相关状态转换回存档代理对象。
        /// </summary>
        /// <param name="proxy">原始的存档代理对象，如果为 null 则创建新实例。</param>
        /// <param name="afflictionDict">包含当前所有疾病状态的字典，键为疾病类型，值为疾病列表。</param>
        /// <returns>
        /// 更新后的 FrostbiteSaveDataProxy 对象。
        /// 该对象包含各个身体部位的冻伤状态、冻伤风险以及冻伤伤害值。
        /// </returns>
